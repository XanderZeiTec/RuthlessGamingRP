...
<div class="col-xs-12" style="position:absolute;top:5px;left:0;position:absolute;overflow:hidden!important;">
	...
	<div class="col-xs-4 infobox">
		<table style="width:100%;" class="reg">
			...
			<tr><td class="text-white text-center"><i class="fa fa-bed"></i></td><td>Prop Push</td></tr>
			...
			<tr><td class="text-white text-center"><i class="fa fa-meh-o"></i></td><td>Forget to read the full rules</td></tr>
			...
			<table style="width:100%;" class="reg">
				...
				<tr>
					<td class="text-white" colspan=2>
						...
						<p>Note: This server is brand new, please give it some time to grow.</p>
						<p>Enjoy!</p>
					</td>
				</tr>
			</table>
	...
	<div class="col-xs-4">
		...
		<div class="col-xs-12 infobox" style="margin-top:10px!important;">
			...
			<span class="text-white txt-shadow" style="padding:5px;">We arnet taking admins just yet while we set up, though you will be able to apply.<strong>We wont listen to "<i>GIV ADMN I TTLY HAV ADMIN SKILLZ</i>"</strong>.</span>
		</div>
