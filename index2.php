...
<div class="col-xs-12" style="position:absolute;top:5px;left:0;position:absolute;overflow:hidden!important;">
	...
	<div class="col-xs-4 infobox">
		<table style="width:100%;" class="reg">
			<tr><td colspan=2 class="text-center hdr"><i class="fa fa-legal" style="color:#D31E1B;"></i> Do not:<td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-bed"></i></td><td>Prop Push/surf</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-tachometer"></i></td><td>RDM (Random Murder)</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-university"></i></td><td>Break NRL (New life rule)</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-microphone-slash"></i></td><td>Mic Spam</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-heartbeat"></i></td><td>Make annoying or Lag Inducing Builds</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-frown-o"></i></td><td>Disrespect anyone</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-meh-o"></i></td><td>Forget to read the rules</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-chain-broken"></i></td><td>Try to crash the Server on Purpose</td></tr>
			<tr><td colspan=2 class="text-white text-center hdr"><i class="fa fa-check-circle" style="color:#24AA22;"></i> Acceptable<td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-bullseye"></i></td><td>Swearing</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-mars-double"></i></td><td>Unadvertised Raiding</td></tr>
			<tr><td colspan=2 class="text-white text-center hdr"><i class="fa fa-thumbs-o-up" style="color:#225FAA;"></i> Key Mods:<td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-cogs"></i></td><td>Wiremod</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-code"></i></td><td>TDM Cars (Cheap)</td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-bug"></i></td><td>H9K Guns/td></tr>
			<tr><td class="text-white text-center"><i class="fa fa-question-circle"></i></td><td>Rp_Downtown_v4c_v3</td></tr>
		</table>
	</div>
	<div class="col-xs-4">
		<div class="col-xs-12">
			<table style="width:100%;" class="reg">
				<tr><td class="text-white hdr"><i class="fa fa-map-marker" style="color:#D12112!important;"></i> Server Location: <span style="color:#1F6FD1!important;">Cardif</span></td></tr>
				<tr><td class="text-white hdl" colspan=2>Note: This server is brand new, please give it some time to grow.</td></tr>
				<tr>
	...
	<div class="col-xs-4">
		<div class="col-xs-12 infobox">
			<table style="width:100%;" class="reg">
				...
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="http://fc02.deviantart.net/fs70/f/2014/341/1/2/simple_crown_bullet_by_slush_bee-d892v68.png"</td><td>FlamePug</td><td>Owner</td></tr>
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="https://forums.alliedmods.net/images/smilies/bee.png"></img></td><td>Xander Ze iTec</td><td>Co-Owner</td></tr>
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="http://fc04.deviantart.net/fs71/f/2015/059/b/1/penis_pixel_by_gaaddammit-d8jwkyb.png"></img></td><td>You?</td><td>Role?</td></tr>
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="http://img4.wikia.nocookie.net/__cb20120430113153/clubpenguin/images/b/bb/Moderator_badge_15px.png"></img></td><td><em>❈</em>AG<em>❈</em>Vacant</td><td>Super Admin</td></tr>
			</table>
		...
		<div class="col-xs-12 infobox" style="margin-top:10px!important;">
			...
			<span class="text-white txt-shadow" style="padding:5px;">We arnet taking admins just yet while we set up, though you will be able to apply.<strong>Also we wont take "<i>GIV ADMN I TTLY HAV ADMIN SKILLZ</i>"</strong>.</span>
		</div>
		<div class="col-xs-12 infobox" style="margin-top:15px!important;">
			...
			<span class="text-white txt-shadow" style="padding:15px!important;">A DarkRP server with friendly staff and intents to have lots of fun! we have only just started out on gmod servers and we want it to start off with a bang!</span>
		</div>
	</div>
</div>
	<script>
		...
		function SetStatusChanged( status ) {
			...
			*/
			...
			if(status == 'Get ready! Sending client info...') {
	...
	<div class="col-xs-12" style="overflow:hidden;position:absolute!important;bottom:25px;">
		...
		$url = 'http://steamcommunity.com/sharedfiles/filedetails/?id=215308097';
